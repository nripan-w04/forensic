...
const HUDCorners = ({ accent }) => (
  <div style={{ position:'absolute', inset:0, pointerEvents:'none', zIndex:4 }}>
    <motion.div animate={{ opacity:[0.4,1,0.4] }} transition={{ duration:2, repeat:Infinity }}
      style={{ position:'absolute', top:100, left:24, width:60, height:60,
    ...
    <motion.div animate={{ opacity:[0.4,1,0.4] }} transition={{ duration:2, repeat:Infinity, delay:0.5 }}
      style={{ position:'absolute', top:100, right:24, width:60, height:60,
    ...
    <motion.div animate={{ opacity:[0.4,1,0.4] }} transition={{ duration:2, repeat:Infinity, delay:1 }}
      style={{ position:'absolute', bottom:80, left:24, width:60, height:60,
    ...
    <motion.div animate={{ opacity:[0.4,1,0.4] }} transition={{ duration:2, repeat:Infinity, delay:1.5 }}
      style={{ position:'absolute', bottom:80, right:24, width:60, height:60,
...
const HeroCarousel = () => {
  ...
  return (
    <section style={{
      ...
      <div style={{ position:'relative', zIndex:10, maxWidth:900, width:'100%', padding:'120px 32px 160px', textAlign:'center' }}>
        <AnimatePresence mode="wait" custom={dir}>
          <motion.div key={cur} custom={dir} variants={contentVariants} initial="enter" animate="center" exit="exit">
            ...
            <p style={{ color:'rgba(255,255,255,0.45)', fontSize:11, textTransform:'uppercase',
      ...
      <div style={{ position:'absolute', bottom:50, right:32, fontFamily:'monospace',
  ...
  <section style={{ padding:'96px 32px', background:C.bg, position:'relative', overflow:'hidden' }}>
    ...
    <div style={{ maxWidth:1100, margin:'0 auto', position:'relative', zIndex:2 }}>
      <motion.div initial={{ opacity:0, y:20 }} whileInView={{ opacity:1, y:0 }}
        ...
        <p style={{ color:C.red, fontSize:10, fontWeight:700, textTransform:'uppercase',
          letterSpacing:'0.4em', fontFamily:'monospace', margin:'0 0 14px' }}>Core Capabilities</p>
        <h2 style={{ color:C.tx1, fontSize:'clamp(34px,5vw,54px)', fontWeight:900,
      ...
      <div className="responsive-grid-3" style={{ gap:20 }}>
        {FEATURES.map((f, i) => (
          <motion.div key={i} initial={{ opacity:0, y:24 }} whileInView={{ opacity:1, y:0 }}
            ...
            <h3 style={{ color:C.tx1, fontSize:13, fontWeight:700,
...
const WorkflowSection = () => (
  <section style={{ padding:'96px 32px', background:C.surface, position:'relative', overflow:'hidden' }}>
    <div style={{ position:'absolute', right:0, top:0, width:400, height:400,
    ...
    <div style={{ maxWidth:780, margin:'0 auto', position:'relative', zIndex:2 }}>
      <motion.div initial={{ opacity:0, y:20 }} whileInView={{ opacity:1, y:0 }}
        ...
        <p style={{ color:C.red, fontSize:10, fontWeight:700, textTransform:'uppercase',
          letterSpacing:'0.4em', fontFamily:'monospace', margin:'0 0 12px' }}>Investigation Workflow</p>
        <h2 style={{ color:C.tx1, fontSize:'clamp(34px,5vw,54px)', fontWeight:900,
        ...
        {WORKFLOW.map((w, i) => (
          <motion.div key={i} initial={{ opacity:0, x:-20 }} whileInView={{ opacity:1, x:0 }}
            ...
            <div style={{
              ...
              <h3 style={{ color:C.tx1, fontSize:17, fontWeight:700,
  ...
  <section style={{ padding:'96px 32px', background:C.bg, position:'relative', overflow:'hidden' }}>
    ...
    <div className="responsive-grid-2" style={{
      ...
      <motion.div initial={{ opacity:0, x:-30 }} whileInView={{ opacity:1, x:0 }} viewport={{ once:true }}>
        <p style={{ color:C.red, fontSize:10, fontWeight:700, textTransform:'uppercase',
          letterSpacing:'0.4em', fontFamily:'monospace', margin:'0 0 12px' }}>AI at the Core</p>
        <h2 style={{ color:C.tx1, fontSize:'clamp(30px,4vw,50px)', fontWeight:900,
      ...
      <motion.div initial={{ opacity:0, x:30 }} whileInView={{ opacity:1, x:0 }}
        ...
        <div style={{
          ...
          <div style={{ display:'flex', alignItems:'center', gap:8, marginBottom:20,
            ...
            <span style={{ marginLeft:12, color:C.tx3, fontSize:10, fontFamily:'monospace',
              textTransform:'uppercase', letterSpacing:'0.18em' }}>FCMS // AI ENGINE TERMINAL</span>
          </div>
        ...
        <motion.div animate={{ y:[0,-8,0] }} transition={{ duration:3, repeat:Infinity, ease:'easeInOut' }}
          style={{ position:'absolute', top:-16, right:-16, background:C.red, color:'#fff',
        ...
        <motion.div animate={{ y:[0,6,0] }} transition={{ duration:4, repeat:Infinity, ease:'easeInOut', delay:1 }}
          style={{ position:'absolute', bottom:-16, left:-16, background:C.sur2,
  ...
  <section style={{ padding:'96px 32px', background:C.surface, position:'relative', overflow:'hidden' }}>
    ...
    <motion.div initial={{ opacity:0, y:20 }} whileInView={{ opacity:1, y:0 }}
      ...
      <div style={{
        ...
        <PulseDot />
        <span style={{ color:C.red, fontSize:10, fontWeight:700, fontFamily:'monospace',
          textTransform:'uppercase', letterSpacing:'0.3em' }}>System Ready</span>
      </div>
      <h2 style={{ color:C.tx1, fontSize:'clamp(42px,7vw,74px)', fontWeight:900,
